...
private:
    Ui::MainWindow *ui;               // <- une seule déclaration
    bool isEditingMoniteur;
    QString currentMoniteurCin;       // CIN du moniteur sélectionné (si édition)
    Moniteur m;                       // instance si tu veux un membre partagé
    QString dernierCin;

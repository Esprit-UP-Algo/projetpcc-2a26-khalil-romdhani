...
public:
    ...
    QString getPhotoPath() const { return photo_path; }
    //teb3a seance-------------
    QSqlQueryModel* getCandidatsDisponibles();
    QSqlQueryModel* getCandidatsDisponibles(const QDate& date, const QString& heureDebut, const QString& heureFin, int idSeanceExclue = -1);
    //-------------------------
};
